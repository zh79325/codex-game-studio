...
import type { GameAgentHandoffNotification } from "./v2/GameAgentHandoffNotification";
import type { GameArtifactCommittedNotification } from "./v2/GameArtifactCommittedNotification";
import type { GameAttemptUpdatedNotification } from "./v2/GameAttemptUpdatedNotification";
import type { GameCharacterUpdatedNotification } from "./v2/GameCharacterUpdatedNotification";
import type { GameConversationActorNotification } from "./v2/GameConversationActorNotification";
import type { GameConversationDeltaNotification } from "./v2/GameConversationDeltaNotification";
import type { GameConversationErrorNotification } from "./v2/GameConversationErrorNotification";
import type { GameConversationFocusNotification } from "./v2/GameConversationFocusNotification";
import type { GameConversationTurnNotification } from "./v2/GameConversationTurnNotification";
import type { GameGenerationUpdatedNotification } from "./v2/GameGenerationUpdatedNotification";
import type { GameRecoveryStatusNotification } from "./v2/GameRecoveryStatusNotification";
import type { GameSpeechCompletedNotification } from "./v2/GameSpeechCompletedNotification";
import type { GameSpeechErrorNotification } from "./v2/GameSpeechErrorNotification";
import type { GameSpeechTranscriptNotification } from "./v2/GameSpeechTranscriptNotification";
import type { GameTaskUpdatedNotification } from "./v2/GameTaskUpdatedNotification";
