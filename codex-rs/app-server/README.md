...
```json
{"id":10,"method":"game/aiProvider/create","params":{"provider":{"code":"openai","name":"OpenAI","baseUrl":"https://api.openai.com/v1","driver":"openai","priority":0,"enabled":true,"hasKey":false,"keyMask":null,"models":[]},"apiKey":"sk-..."}}
