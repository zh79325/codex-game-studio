...
pub(crate) fn without_notification_media(notification: ServerNotification) -> ServerNotification {
    match notification {
        ...
        | ServerNotification::GameTaskUpdated(_)
        | ServerNotification::GameAttemptUpdated(_)
        | ServerNotification::GameConversationTurn(_)
        | ServerNotification::GameConversationDelta(_)
        | ServerNotification::GameConversationActor(_)
        | ServerNotification::GameConversationFocus(_)
        | ServerNotification::GameConversationError(_)
        | ServerNotification::GameAgentHandoff(_)
        | ServerNotification::GameCharacterUpdated(_)
        | ServerNotification::GameGenerationUpdated(_)
        | ServerNotification::GameArtifactCommitted(_)
        | ServerNotification::GameRecoveryStatus(_)
        | ServerNotification::GameSpeechTranscript(_)
        | ServerNotification::GameSpeechCompleted(_)
        | ServerNotification::GameSpeechError(_)
